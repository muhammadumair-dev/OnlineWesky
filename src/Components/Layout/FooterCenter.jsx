...
function FooterCenter() {
  ...
  return (
    <div className="h-fit py-[50px] block lg:flex md:block md:h-fit  justify-between text-white bg-[url('https://www.onlinecava.com/wp-content/uploads/2020/05/onlinecava-footer.jpg')] bg-cover bg-center px-4">

      {/* Left Section */}
      <div className="w-full lg:w-[40%]  md:w-[100%] wid">
      ...
      {/* Right Section */}
      <div className="w-full  lg:w-[50%] md:w-[100%] wid mart">
